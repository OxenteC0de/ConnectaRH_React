        ...
        <div className="container mx-auto grid md:grid-cols-2 items-center  min-h-screen px-8">
          ...
          <div className="flex flex-col justify-center text-center md:text-left space-y-6">
            ...
            <p className="text-xl leading-relaxed text-gray-200">
              O ConnectaRH é um sistema de gerenciamento de cadastros
              desenvolvido para equipes de RH que buscam agilidade e organização
              no controle de colaboradores e processos internos.
            </p>
          </div>
          ...
          <div className="flex flex-col justify-center text-center md:text-left space-y-6 pl8">
            ...
            <p className="text-xl leading-relaxed text-gray-200">
              ...
              as informações sobre nome, cargo, departamento e salário.
            </p>
          </div>
        </div>
      </section>
